...
def add_bg_from_url():
    st.markdown(
         ...
         <style>
         .stApp {{
             background-image: url("https://blog.barracuda.com/wp-content/uploads/2019/06/Generic_Spam_1200x628.png");
...
st.title('Ham/Spam - Email Classifier')
review = st.text_input("Email:", value="")
if st.button('Predict'):
    if loaded_model.predict(loaded_vectorizer.transform(clean_text(review)))[0] == 'ham':
        st.write('Given Email is Ham')
    else:
        st.write('Given Email is Spam')